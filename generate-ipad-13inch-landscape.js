...
// Dimensions iPad 13" LANDSCAPE - Apple App Store requirements
const width = 2796;
const height = 1290;
...
fs.writeFileSync('sentreso-finance-ipad-13inch-landscape-apple.png', buffer);

console.log('✅ Screenshot iPad 13" LANDSCAPE généré pour Apple !');
console.log('📁 Fichier : sentreso-finance-ipad-13inch-landscape-apple.png');
console.log('📏 Dimensions : 2796 × 1290px (iPad 13" Landscape)');
